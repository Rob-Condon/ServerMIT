<template>
    <div style="background-color: #dadbe0" class="wrapper">
      ...
      <div style="padding-top: 90px; position: relative; z-index: 1;" id="ItemOne"  class="ServiceItem">
        ...
        <img class="ServiceIcon" style="transform: translate(-120px, -140px); height: 475px" src="../../assets/images/svg/computerSystems.png" alt="Ah shit lost it again">

        <h1 class="ServiceNumber">01</h1>
      ...
      <div id="ItemTwo"  class="ServiceItem">
        <img class="ServiceIcon" style="transform: translate(-700px, -200px); height: 425px" src="../../assets/images/svg/breakfixServices.png" alt="Ah shit lost it again">
        <h1 class="ServiceNumber">02</h1>
      ...
      <div id="ItemThree"  class="ServiceItem">
        <img class="ServiceIcon" style="transform: translate(-700px, -285px); height: 425px" src="../../assets/images/svg/ServerManagement.png" alt="Ah shit lost it again">
        <h1 class="ServiceNumber">03</h1>
      ...
      <div id="ItemFour"  class="ServiceItem">
        <img class="ServiceIcon" style="transform: translate(-700px, -285px); height: 425px" src="../../assets/images/svg/disasterRecovery.png" alt="Ah shit lost it again">
        <h1 class="ServiceNumber">04</h1>
        <div style="transform: translateY(-185px)" class="ServiceMegaContent">
          <div class="ServiceContent">
      ...
      <div id="ItemFive"  class="ServiceItem">
        <img class="ServiceIcon" style="transform: translate(-700px, -285px); height: 425px" src="../../assets/images/svg/networking.png" alt="Ah shit lost it again">
      ...
      <div id="ItemSix" name="ItemSix"  class="ServiceItem">
        <img class="ServiceIcon" style="transform: translate(-700px, -285px); height: 425px" src="../../assets/images/svg/databaseManagement.png" alt="Ah shit lost it again">
        <h1 class="ServiceNumber">06</h1>
        <div style="transform: translateY(-185px)" class="ServiceMegaContent">
          <div class="ServiceContent">
      ...
      <div id="ItemSeven"  class="ServiceItem">
        <img class="ServiceIcon" style="transform: translate(-700px, -285px); height: 425px" src="../../assets/images/svg/security.png" alt="Ah shit lost it again">
        <h1 class="ServiceNumber">07</h1>
        <div style="transform: translateY(-185px)" class="ServiceMegaContent">
          <div class="ServiceContent">
      ...
      <div id="ItemEight" style="margin-bottom: -200px"  class="ServiceItem">
        <img class="ServiceIcon" style="transform: translate(-700px, -285px); height: 425px" src="../../assets/images/svg/cloudComputing.png" alt="Ah shit lost it again">
        <h1 class="ServiceNumber">08</h1>
        <div style="transform: translateY(-185px)" class="ServiceMegaContent">
          <div class="ServiceContent">
...
<script>
  ...
  let $ = JQuery;
    export default {
        name: "OurServices",
      components: {Navbar, SLAPackages, OurServicesTitle, OurServicesIcons, Footer},
      data () {
        return {
      ...
      methods: {
        TransitionOn(Int) {
          ...
          console.log(this.ReadMoreArray[1].ReadBool + " And " +  this.ReadMoreArray[1].TransitionBool);
        }
      },
      mounted() {
