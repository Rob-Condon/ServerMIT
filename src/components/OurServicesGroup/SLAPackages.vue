<template>
    <div style="background-color: #dadbe0; padding-bottom: 100px">
      ...
      <transition name="PackageAniLeft" :key="Packages">
        <div id="Packages" v-if="Packages" style="margin-left: 10%" class="Package">
      ...
      <transition name="PackageAniRight" :key="Packages">
        <div v-if="Packages" style="margin-right: 10%;" class="Package">
          <div style="background-color: #cdced3;">
      ...
      <div class="BreakFix">
        <div class="BreakFixContent">
          ...
          <div class="ServiceDiv_" style="position: relative; margin: auto" @click="ServiceClick(1)">
